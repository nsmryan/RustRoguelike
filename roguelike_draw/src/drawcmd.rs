...
pub enum DrawCmd {
    ...
    Rect(Pos, u32, u32, f32, bool, Color), // start cell, num cells width/height, offset percent into cell, filled, color
    #[display("rect_float {0} {1} {2} {3} {4} {5}")]
    RectFloat(f32, f32, f32, f32, bool, Color), // x, y, width/height, filled, color
    #[display("fill {0} {1}")]
    Fill(Pos, Color),
}
